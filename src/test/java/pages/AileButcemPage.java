...
public class AileButcemPage {
    ...
    public void loginMethodu() throws InterruptedException {
        Thread.sleep(2000);
        for (int i=0; i<6;i++){
            ReusableMethods.screenScroolMethod(968,1081,750,139,1081,1000);
        }
    }
    ...
    public void kullaniciBilgileriDegistirmeMethodu(String isim,String soyisim,String sehir,String yas,String meslek,String kaydet) throws InterruptedException {
